    ...
    <PageLayout>
      <div className="max-w-lg mx-auto">
        ...
        <div className="space-y-4 text-[#5a4a6a]">
          ...
          <p>
            This project was created by a solo developer who got tired of the morning bathroom bottleneck and decided to fix it. One trip, one idea and one simple solution.
          </p>
        </div>
        <div className="mt-8 flex flex-col items-center">
          <img src="/headshot.png" alt="Zach Simonson" className="w-32 h-32 rounded-full object-cover border-2 border-[#e5dfed]" />
          <a href="https://zachsimonson.com" target="_blank" rel="noopener noreferrer" className="mt-3 text-[#5a4a6a] hover:text-[#f4a6b8] font-medium text-sm">
            Zach Simonson, Founder
          </a>
        </div>
